...
directory or this partition, please choose another location for your work directory."))
        ...
        # Else we build LiveClone main module out of the running environment
            ...
            # there's more work, return True
            yield True
            subprocess.call("mksquashfs / " + live_workdir + "/" + SaLTRootDir + "/modules/01-clone.salt -keep-as-directory -b 1M -comp xz -Xbcj x86 -Xdict-size '50%' -wildcards -e 'media/*' 'mnt/*' 'tmp/*'  '... *pid' '... wicd/*-settings.conf' ", shell=True)
